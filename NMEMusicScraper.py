...
for element in posts:
	...
	article_link =  element.contents[7].text.encode('utf8')
	article_title = element.contents[1].text.encode('utf8')
	article_image = element.contents[13]["url"]
	article_preview = element.contents[3].text.encode('utf8')
	article_body = element.contents[17].text.encode('utf8')
	...
	articles[articleCount]["preview"] = article_body
