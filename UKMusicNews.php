											...
											while(! feof($file))
											  {
												...
												if($articleCounter == 0)
												{
													...
													echo "<div class='news-left-container' id='UKNews'>";
													echo "<img class='newsimage' src='$article_array[3]' />";
													echo "<h1><a href='$article_array[2]' onClick='popUpClick(this); return false;'> $article_array[0] </a></h1>";
												...
												else if($articleCounter == 1)
												{
													...
													echo "<div class='news-center' id='UKNews'>";
												...
												else
												{
													...
													echo "<div class='news-right' id='UKNews'>";
